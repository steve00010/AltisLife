...
_msg = format["Vehicle Sell Log: %1 (%2) has sold a %3 for $%4",profileName, getPlayerUID player,getText(configFile >> "CfgVehicles" >> _vehicle >> "displayName"),[_price] call life_fnc_numberText];
