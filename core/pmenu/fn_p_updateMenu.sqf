...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='icons\bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='icons\money.paa'/> <t size='0.8'>$%2</t>",[pbh_life_atmcash] call life_fnc_numberText,[pbh_life_cash] call life_fnc_numberText];
