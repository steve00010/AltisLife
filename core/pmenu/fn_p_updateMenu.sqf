...
_side = switch(playerSide) do {case west:{"cop"}; case east:{"adac"}; case civilian:{"civ"}; case independent:{"med"};};
...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='icons\bank.paa'/> <t size='0.8px'>$%1</t> <img size='1.2' image='icons\money.paa'/> <t size='0.8'>$%2</t>",[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
