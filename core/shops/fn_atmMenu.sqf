...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='icons\bank.paa'/> $%1<br/><img size='1.6' image='icons\money.paa'/> $%2",[pbh_life_atmcash] call life_fnc_numberText,[pbh_life_cash] call life_fnc_numberText];
