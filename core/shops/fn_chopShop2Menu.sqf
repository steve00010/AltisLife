...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["There are no vehicles near to claim.","PLAIN"];};
if(!(createDialog "Chop_Shop2")) exitWith {hint "There was a problem opening the chop shop menu."};
