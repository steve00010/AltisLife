...
{
	case 1: {ctrlShow [2904,false];ctrlShow [2906,false];ctrlShow [2907,false];ctrlShow [2908,false];ctrlShow [2909,false];ctrlShow [2911,false];};
	...
	case 3: {ctrlShow [2908,false];ctrlShow [2911,false];ctrlShow [2906,false]};
