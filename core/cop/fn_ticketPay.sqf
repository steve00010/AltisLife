...
if(pbh_life_cash < life_ticket_val) exitWith
{
	if(pbh_life_atmcash < life_ticket_val) exitWith 
	{
	...
	pbh_life_atmcash = pbh_life_atmcash - life_ticket_val;
...
pbh_life_cash = pbh_life_cash - life_ticket_val;
life_ticket_paid = true;
