...
switch (_var) do
{
	...
	case "life_inv_goldbarp": {("icons\items\goldbarp.paa")};
	case "life_inv_underwatercharge": {("icons\items\underwatercharge.paa")};
	case "life_inv_kidney": {("icons\items\kidney.paa")};
	case "life_inv_surgeryknife": {("icons\items\surgeryknife.paa")};
	case "life_inv_zipties": {("icons\items\zipties.paa")};
	case "life_inv_scatchcard": {("icons\items\scratchcard.paa")};
	...
	case "life_inv_beerp": {("icons\items\beerp.paa")};
