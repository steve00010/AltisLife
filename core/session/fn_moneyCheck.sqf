...
_returnMe = true;
if(_playtime < 7200 && pbh_life_atmcash > 1500000 OR _playtime < 7200 && pbh_life_cash > 1500000) {
	_returnMe = false;
}
if((_playtime < 14400 && pbh_life_atmcash > 4000000) OR( _playtime < 7200 && pbh_life_cash > 4000000)) {
	_returnMe = false;
}
