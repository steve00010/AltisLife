...
if(pbh_life_atmcash < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-pbh_life_atmcash)] call life_fnc_numberText];};
