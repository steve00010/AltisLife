...
diag_log "PLAYER SET ONLINE 1";
life_fnc_garageRefund = compileFinal
"
	_price = _this select 0;
	_unit = _this select 1;
	if(_unit != player) exitWith {};
	pbh_life_atmcash = pbh_life_atmcash + _price;
";
...
// Give ATM Insurance to anyone with greater than 2 donor
...
{
	case 0: { life_houseLimit = 2; };
	case 1: { life_houseLimit = 4; };
	case 2: { life_houseLimit=  5; };
	case 3: { life_houseLimit = 6; };
	case 4: { life_houseLimit = 7; };
	case 5: { life_houseLimit = 8; };
};
