...
Notes:
	...
	_targets = ["Radio Hill","Military Range","Stratis Air Base","Air Station Mike-26","Camp Tempest","Jay Cove","Camp Maxwell"];
...
while { count _targetArray > 0 } do {
	...
	_DACvalues = ["Main_AO",[2,0,0],[10,3,50,5],[4,2,30,5],[2,1,20,5],[1,2,50,1,0,0],[0,0,0,0]];
