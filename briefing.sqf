		...
		[
			"Custom Change Log",
				"	
					...
					1. Added Economy System / Market fluctuation of prices.
					2. Fixed Various Bugs.
					3. Added various textures for cop cloths and vehicles.
					4. Rebuilt Prison.
					5. Rebuilt and Moved Rebel bases.
					6. Added silent alarm markers when robbing shops.
					7. Added Smart-phone
					8. Added trigger warnings in zones, and upon entering Reb Zone for Police.
					9. Fixed glitches with various NPCs
					10. Added Set jail time for cops, Yes they can send you to Jail for 1 Hour now, you have been warned.
					11. Added Cops can manually add players to the Wanted list for petty and serious crimes (WIP).
					12. Added new Market Square.
					13. Rebuilt Athira Police HQ.
					14. Added Rebel Chop-Shop
					15. Added Rebels can only spawn at Rebel Camp unless they own a house or relinquish their license."
		]
	];
